  ...
  const fetchCourseDetails = () => {
    if (allCourses && allCourses.length > 0) {
      const findCourse = allCourses.find(
        course => String(course.id || course._id) === String(id)
      );
    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-28 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-course-deatails-heading-large text-2xl font-semibold text-gray-800">
          ...
          <p>
            Course By <span className="text-orange-600 underline">SHEHAN</span>
          </p>
          ...
          <div className="pt-8 text-gray-800">
            ...
            <div className="pt-5">
              {courseData.courseContent?.map((chapter, index) => (
                <div key={index} className="border border-gray-300 bg-white rounded mb-3">
                  <div
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          {
                ...
                <YouTube videoId={playerData.videoId} opts={{playerVars:{
                  autoplay:1
                }}} iframeClassName='w-full aspect-video'/>:<img src={courseData.courseThumbnail} alt="Thumbnail" />
          ...
          <div className="p-5">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-800 md:text-4xl text-2xl font-semibold">
                {currency}
                {((courseData.coursePrice ?? 0) - ((courseData.discount ?? 0) * (courseData.coursePrice ?? 0)) / 100).toFixed(2)}
              </p>
            ...
            <button className='md:mt-6 mt-4 w-full py-3 rounded bg-orange-600 text-white font-medium'>{isAlreadyEnrolled ? 'Alredy Enrolled': 'Enroll Now'}</button>
            <div className='pt-6'>
